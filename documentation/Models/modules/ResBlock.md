...
A 16→16 3×3×3 convolution on a 128³ volume is the most expensive operation in Stage B. Measured, the residual pair at the finest scale cost **350 ms of a 530 ms** training step — two thirds of `B` — for 6% more parameters. Depth is cheaper one octave down. Recorded in `docs/proposal/deviations.md` §4.2.
