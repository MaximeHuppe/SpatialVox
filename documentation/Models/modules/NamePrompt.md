...
The square projection is mathematically redundant with the table. It exists because the reference checkpoint contains it (`tests/test_reference_parity.py` compares bitwise; those tests **skip** on this clone).
